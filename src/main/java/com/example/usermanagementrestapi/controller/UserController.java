...
public class UserController {
    ...
    @ApiOperation(value = "Get list user with paging", response = com.example.usermanagementrestapi.entity.User.class, responseContainer = "List")
    @ApiResponses({
            @ApiResponse(code=500,message = "")
    })
    ...
    public ResponseEntity<?> getListUserLikeName(@RequestParam(required = false) Integer page) {
        ...
        Page<com.example.usermanagementrestapi.entity.User> result = userService.findUserLikeName("John", currPage);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateUser(@Valid @RequestBody com.example.usermanagementrestapi.model.request.UpdateUserReq req, @PathVariable int id) {
    ...
    @PostMapping("/upload")
    public ResponseEntity<?> uploadFile(@ModelAttribute("uploadForm") com.example.usermanagementrestapi.model.request.UploadFile form) {
